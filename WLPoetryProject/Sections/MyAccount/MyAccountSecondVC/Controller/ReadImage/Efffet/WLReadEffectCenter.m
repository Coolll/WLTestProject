...
- (void)loadMapleLeafEffectWithSuperView:(UIView*)superView{
    ...
    CAEmitterCell *cell = [[CAEmitterCell alloc]init];
    //粒子要展现的图片
    cell.contents = (__bridge id)[UIImage imageNamed:@"effect_maple_leaf"].CGImage;
    //粒子产生的速率
    cell.birthRate = 1;
    //粒子的存在时间
    cell.lifetime = 8.0;
...
- (UIImage*)loadImageWithType:(WLEffectType)type{
    if (type == WLEffectTypePlum) {
